...
//		ResultSetExtractor<Emp01Vo> rse=null;
//		rse=new ResultSetExtractor<Emp01Vo>() {
//			@Override
//			public Emp01Vo extractData(ResultSet rs) throws SQLException, DataAccessException {
//				return new Emp01Vo(
//							rs.getInt(1),
//							rs.getString(2),
//							rs.getTimestamp(3),
...
//		};
	...
	@Override
	public int updatetOne(Emp01Vo bean) throws SQLException {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int deletetOne(int num) throws SQLException {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public boolean loginCheck(int sabun, String name) throws SQLException {
